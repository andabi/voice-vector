...
def get_remote_data_loader(port, nr_prefetch=1000, nr_thread=1):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_feeder', default='false')
    ...
    if args.use_feeder:
        data_loader = get_remote_data_loader(args.port, hp.train.batch_size)
    else:
    ...
    if True:
        ...
        train_conf = TrainConfig(
            ...
            data=FlexibleQueueInput(data_loader, capacity=3000),
            callbacks=[
        ...
        data_loader = TestDataSpeed(data_loader, 100000)
        for _ in data_loader.get_data():
            pass
